...
def main():
    X_train, y_train = m.import_file('../train_post60.csv', "yr10")
    X_cv, y_cv = m.import_file('../test_post60.csv', "yr10")
    ...
    m.save_preds(predic, './out/LR_extra2_p60_10_test_preds.csv')
